...
public class CourseController {
  ...
  @GetMapping("/courses/{course_id}/students/grades")
  public List<StudentGrade> getStudentsFinalGradesByCourseId(
      @PathVariable("course_id") String courseId,
      @RequestParam(value = "group_refs", required = false) String groupRef) {
    return gradeService.getFinalGradesByCourseId(courseId, groupRef).stream()
